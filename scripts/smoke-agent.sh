...
BINARY_PATH="${REPO_ROOT}/dist/shareme-agent"
SKIP_BUILD="${1:-}"
...
HOME="${HOME_DIR}" \
SHAREME_DATA_DIR="${RUNTIME_DIR}" \
SHAREME_AGENT_TCP_PORT="${AGENT_TCP_PORT}" \
SHAREME_LOCAL_HTTP_PORT="${LOCAL_HTTP_PORT}" \
SHAREME_ACCELERATED_DATA_PORT="${ACCELERATED_DATA_PORT}" \
SHAREME_DISCOVERY_UDP_PORT="${DISCOVERY_UDP_PORT}" \
SHAREME_DISCOVERY_LISTEN_ADDR="127.0.0.1:${DISCOVERY_UDP_PORT}" \
SHAREME_DISCOVERY_BROADCAST_ADDR="127.0.0.1:${DISCOVERY_UDP_PORT}" \
