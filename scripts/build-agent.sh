...
AGENT_FRONTEND_DIR="${BACKEND_DIR}/cmd/shareme-agent/frontend"
...
OUTPUT="${1:-${REPO_ROOT}/dist/shareme-agent}"
...
cd "${BACKEND_DIR}"
GOCACHE="${GO_CACHE_DIR}" GOTELEMETRY=off go build -o "${OUTPUT}" ./cmd/shareme-agent
